...
public class DrinkXmlValidationTest {
    private final String BASE_URL = "http://localhost:8000/recipe/drink?alcoholic=";
    private final String XSD_PATH = "src/main/resources/RecipeDrink.xsd"; // Chemin vers votre fichier XSD
